...
6. **Диагностическое логирование** — `finalizeGyroDetection()` теперь всегда пишет в консоль: `osDelta`, `gyroAccum`, `ratio`, `correction`, `elapsed`.
...
- Диагностика в консоли упрощает отладку на конкретном устройстве.
